...
-(void) setupLayers
{
    ...
    for (double i = 0.0; i < SQUARES_ACROSS; ++i)
    {
        for (double j = 0.0; j < SQUARES_DOWN; ++j)
        {
            ...
            CGRect squareFrame = CGRectMake(size.width*i/SQUARES_ACROSS+padding,
                                            size.height*j/SQUARES_DOWN+padding,
                                            size.width/SQUARES_ACROSS-2*padding,
                                            size.height/SQUARES_DOWN-2*padding);
